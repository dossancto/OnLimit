...
using OnLimit.Mysql.Entities;

namespace OnLimit.Mysql.Repositories;

public class MysqlUsageRepository(
    MySqlConnection connection,
    OnLimitMysqlConfig config
    ) : IUsageRepository
{
    ...
    public async Task<UsageUserPlans?> GetCurrentPlan(string Id, DateTime? at = null)
    {
        ...
        var res = await connection.QueryFirstOrDefaultAsync<MysqlUsageUserPlans>(SQL, new
        {
            id = Id,
            date = date
        });
    ...
    public async Task<UsageUserPlans?> GetLatestUserPlan(string Id)
    {
        ...
        var res = await connection.QueryFirstOrDefaultAsync<MysqlUsageUserPlans>(query, new { id = Id });
    ...
    public async Task SetPlan(string orgId, string plan, DateTime? at = null, string? externalPaymentId = null)
    {
        ...
        var model = new MysqlUsageUserPlans()
        {
            Id = Guid.NewGuid(),
            UserId = orgId,
            CreatedAt = now,
